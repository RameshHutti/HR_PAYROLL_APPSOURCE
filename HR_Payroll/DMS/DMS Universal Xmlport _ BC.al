xmlport 60548 "DMS Universal XMLport"
{
    ...
    var
        ...
        StatusL: Enum "Reservation Status";
            ...
            repeat
                ...
                IF (lrecItemJnl."Serial No." <> '') OR (lrecItemJnl."Lot No." <> '') THEN BEGIN
                    lcuCreateResEntry.CreateReservEntryFor(
                                    ...
                                    lrecItemJnl."Entry Type",
                                    lrecItemJnl."Journal Template Name",
                                     lrecItemJnl."Journal Batch Name",
                                    0,
                                    lrecItemJnl."Line No.",
                    ...
                    lcuCreateResEntry.CreateEntry(
                      lrecItemJnl."Item No.",
                      lrecItemJnl."Variant Code",
                      lrecItemJnl."Location Code",
                      lrecItemJnl.Description,
                      lrecItemJnl."Posting Date",
                      0D,
                      0,
                     StatusL::Prospect
                    );
